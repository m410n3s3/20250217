...
class JanelaApresentacao(): 
	...
	def CriarPaginaApresentacaoTopo(self): 		
		...
		self.ContainerPaginaApresentacaoTopo.rowconfigure(0, weight = 1) #Colocar tres botoes na linha 1
		self.ContainerPaginaApresentacaoTopo.columnconfigure(0, weight = 3)
		self.ContainerPaginaApresentacaoTopo.columnconfigure(1, weight = 1)
		self.ContainerPaginaApresentacaoTopo.columnconfigure(2, weight = 3)
		self.ContainerPaginaApresentacaoTopo.grid(row = 0, column = 0,sticky = tk.EW)
	...
	def PaginaApresentacaoBotoesCentro(self):
		...
		filename = "Tela_entrada_BancoPython.jpg"
